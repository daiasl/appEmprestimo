		...
		<table class="table table-striped">
			...
			<tbody>
				...
				<tr>
					<td>codigoBarras</td>
					<td>String</td>
					<td>Representação gráfica de uma sequência numérica utilizada
						para identificar um produto.</td>
				</tr>
				<tr>
					<td>qtdExemplares</td>
					<td>int</td>
		...
		<table class="table table-striped">
			...
			<tbody>
				<tr>
					<td>isbn</td>
					<td>String</td>
					<td>Padrão de identificação de numeração dos livros a serem
						emprestados.</td>
				</tr>
				<tr>
					<td>volume</td>
		...
		<table class="table table-striped">
			...
			<tbody>
				<tr>
					<td>issn</td>
					<td>String</td>
					<td>Número internacional normalizado para publicações
						seriadas, como é o caso de Revistas.</td>
				</tr>
				<tr>
					<td>edicao</td>
					<td>int</td>
